...
\TODO{HF: Loic, Nicolas, can you complete this, please?}
  ...
  \TODO{Explain first why this frame work is ideal (text below), and then how the
    faculty has bought into it (text above) as further evidence?}
  ...
  project for tasks XXX will be presented and discussed. {\bf link with WP
    dissemination}
  \TODO{What are Jupyter days? - should explain or link to explanation}

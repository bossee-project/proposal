...
\begin{table}
  ...
  \begin{tabular}{|m{.3\textwidth}|m{.7\textwidth}|}
    ...
    \taskref{applications}{teaching},
    \taskref{applications}{application-gpu},
    \taskref{applications}{geoscience},
    \taskref{applications}{opendose-analysis},
    \taskref{applications}{math},
    ...
    \taskref{education}{online-resources},
    \taskref{education}{helpdesk}

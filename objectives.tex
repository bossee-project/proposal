...
\item Support and steer the Jupyter software ecosystem, as a
  ...
  \TODO{insert something about open source and open standards.
    Basically we want to recall here Jupyter's mission: Project
    Jupyter exists to develop open-source software, open-standards,
    and services for interactive computing across dozens of
...
\item Leverage this technology for all scientists, across borders,
  ...
  free public distributed collaborative services tightly integrated
  into the European Open Science Cloud (EOSC).
  \TODO{``operation'' does not convey that this is a joint effort with
    the community, and we will only operate ourselves some of the
    nodes of the federation. Maybe we should just remove ``the
    operation of''}
...
\item \label{obj:deployment} \TODO{potential title: Generic distributed Jupyter infrastructure and services for the EOSC}%
  ...
  same toolbox.\TODO{convey that the toolbox fosters interoperability
    and separation of concern, so the instances can easily integrate
    tools outside of the Jupyter ecosystem}

...
\software{Cloud@VD} (see below), enabling students and teachers to
...
\software{Cloud@VD} (3500 cores / 1 Po storage) for its personnel. The participants
...
JupyterHub service on this infrastructure (joint work with \site{EP}), \software{Cloud@VD} will be

...
\site{WTT} requests 37 person months to provide the effort required.
...
\site{INSERM} requests 33 person months to provide the effort required.
...
\begin{tabular}{|r|r|p{8.5cm}|}
  ...
  \textbf{Travel} &  40670 & Travel for PI and $\approx$0.7 researchers (see the guidelines
                             \ref{sect:budget-details-travel})\\\hline

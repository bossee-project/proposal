...
\TheProject applies for a total budget of \textbf{¤ 5,934,411.25} as the amount 
...
\item \textbf{The inputs necessary to resource planning}; further, the timetable of a
ctivities has helped to identify when each resource will be needed in the project.

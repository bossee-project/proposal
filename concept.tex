...
\medskip
\noindent\textbf{Jupyter ecosystem}\label{jupyter-ecosystem}
...
\medskip
\noindent\textbf{Demonstrator: Nuclear Medicine application (\taskref{applications}{opendose-analysis})}\label{sec:concept-demonstrators-opendose}\\

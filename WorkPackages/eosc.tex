...
\begin{wpdelivs}
    \begin{wpdeliv}[due=06,miles=community,id=eosc-annual-report,dissem=PU,nature=R,lead=EGI]
    {This deliverable will describe the technical and service provisioning integration activities required to ensure the provisioning of BOSSEE services through EOSC}
  \end{wpdeliv}
  ...
  \end{wpdeliv}
  \begin{wpdeliv}[due=12-24-36,miles=community,id=eosc-annual-report,dissem=PU,nature=R,lead=EGI]
    {This annual report will include the technical and service provisioning integration activities and their status}
  \end{wpdeliv}
\end{wpdelivs}
\end{workpackage}
%%% Local Variables:

...
\begin{wpdelivs}
  ...
  \end{wpdeliv}
  \begin{wpdeliv}[due=36,miles=community,id=eosc-annual-report,dissem=PU,nature=R,lead=EGI]
    {Annual reports including technical and service provisioning integration activities and their status}
  \end{wpdeliv}
\end{wpdelivs}
\end{workpackage}
%%% Local Variables:

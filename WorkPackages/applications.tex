...
%\TODO{update milestone!}
  ...
  \begin{wpdeliv}[due=9,miles=final,id=codesign-support,dissem=PU,nature=DEM,lead=SRL]
    {Initial requirements for the demonstrators.}
  \end{wpdeliv}

  \begin{wpdeliv}[due=24,miles=final,id=local-services,dissem=PU,nature=DEM,lead=EP]

...
\noindent \longtaskref{applications}{opendose-analysis}
will use data generated by the OpenDose project. The open data will be accessed
via SQL queries on a remote database server. This demonstrator will not
generate or collect data.

\noindent \longtaskref{applications}{math}
will not generate or collect data.

\noindent \longtaskref{applications}{teaching}
...
\noindent \textbf{Demonstrator: Astronomy (\taskref{applications}{astro})}
This demonstrator will access public data delivered by CDS services through Virtual Observatory protocols.  It will not generate nor collect data per se.

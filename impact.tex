...
to \textbf{support diversity and inlcusion in the Open Science community},
...
Also, we will identify and attend conferences from complementary communities such as ROpenSci, Mozilla Science, and Julia
as well as domain specific conferences to maximise the impact \TheProject and to broaden its audience outside from the 
traditionaly included communities.
In addition, we will operate a website (\taskref{education}{website})
for collecting and sharing information about \TheProject and its progress.

In addition, we will operate a website (\taskref{education}{\textbf{website}})
for collecting and sharing information about \TheProject and its progress. It will provide a centralised 
access to the various publicly available deliverables, publications and articles related 
...
A Google Analytics account will be associated with the project website, in order 
to provide useful insight on how to improve its impact. 

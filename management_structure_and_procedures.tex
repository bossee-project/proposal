...
\begin{tabular}{|m{.2\textwidth}|m{.12\textwidth}|m{.58\textwidth}|}\hline
  ...
  EOSC validation and integration & High/Low &
  In order to deploy services on EOSC and make them available,
  we must make sure our services are validated
  and operational to to the satisfaction of EOSC.
  By including \site{EGI} as a partner,
  we have the support and expertise of a core EOSC participant,
  to help us navigate EOSC requirements for \TheProject services.
  \\\hline

...
\begin{tabular}{|m{.2\textwidth}|m{.12\textwidth}|m{.58\textwidth}|}\hline
  Risk & Level with/without mitigation & Mitigation measures\\\hline
   ...
   \multicolumn{3}{|c|}\textit{General technical / scientific risks}\\\hline
  ...
  \multicolumn{3}{|c|}\textit{Use-case risks}\\\hline
  % TO WRITE
  
  \multicolumn{3}{|c|}\textit{Management risks}\\\hline
  ...
  \multicolumn{3}{|c|}\textit{Dissemination risks}\\\hline

...
%  \\\hline
  ...
  (e.g. in the developers community of software related to the project),
  and coordinating with currently running projects to rehire personnel
  with strong track record. We have a critical mass of
  ...
  Partners in the consortium have a proven track record at community building,
  training, dissemination, and outreach, which reduces the risk. The Project Coordinator

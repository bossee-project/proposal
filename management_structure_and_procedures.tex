...
at \TODO{PSC} level will be submitted to the Coordinator. The
...
to be provided to the conflicting parties and \TODO{PSC}.
\item Final decision to resolve the conflict made by \TODO{PSC}.
\end{itemize}
